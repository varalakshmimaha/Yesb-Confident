...
<head>
  ...
  <style>
    ...
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .alert{padding:14px 20px;border-radius:10px;margin-bottom:16px;font-size:13px;font-weight:600;display:flex;align-items:center;gap:8px}
    .alert-success{background:#dcf5e7;color:#1a8a4a}
    .alert-error{background:#fdecea;color:#C0392B}
    .ef-errors{list-style:none;margin:0;padding:0}
    .ef-errors li{color:#C0392B;font-size:12px;margin-bottom:4px}
...
<div class="hero-slider" id="heroSlider">
  <div class="slide active">
    ...
    <div class="slide-content">
      ...
      <div class="slide-right">
        <div class="slide-image"><img src="https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=500&q=80" alt="Electronics"></div>
      </div>
    </div>
  </div>
  ...
  <div class="slide">
    ...
    <div class="slide-content">
      ...
      <div class="slide-right">
        <div class="slide-image"><img src="https://images.unsplash.com/photo-1483985988355-763728e1935b?w=500&q=80" alt="Fashion"></div>
      </div>
    </div>
  </div>
  ...
  <div class="slide">
    ...
    <div class="slide-content">
      ...
      <div class="slide-right">
        <div class="slide-image"><img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=500&q=80" alt="Advertising"></div>
      </div>
    </div>
  </div>
  ...
  <div class="section" style="padding-bottom:40px">
    ...
    <div class="obj-cards-grid">
      <div class="obj-v2 reveal">
        ...
        <div class="obj-v2-body"><h3>Quality & Trust</h3><p>Providing quality products that are good and trustworthy to every customer. We carefully curate our catalog so customers shop with confidence.</p></div>
      </div>
      <div class="obj-v2 reveal">
        <div class="obj-v2-icon"><i class="fas fa-headset"></i></div>
        <div class="obj-v2-body"><h3>Continuous Service</h3><p>Providing continuous, reliable quality service that goes beyond the sale. From pre-purchase guidance to after-sales support, we build lasting relationships.</p></div>
      </div>
      <div class="obj-v2 reveal">
        <div class="obj-v2-icon"><i class="fas fa-briefcase"></i></div>
        <div class="obj-v2-body"><h3>Empowering Youth</h3><p>Creating advertising and sales jobs for unemployed youth — roles in constant demand. We give real experience, practical skills, and meaningful work.</p></div>
      </div>
      <div class="obj-v2 reveal">
        <div class="obj-v2-icon"><i class="fas fa-lightbulb"></i></div>
        <div class="obj-v2-body"><h3>Innovation & Growth</h3><p>An innovative platform that meets modern-day demands — combining e-commerce and advertising to build a platform that grows with you.</p></div>
      </div>
    </div>
  </div>
  <div class="youth-section">
    <div class="youth-grid reveal">
      <div class="youth-img-side"><img src="https://images.unsplash.com/photo-1529390079861-591de354faf5?w=700&q=80" alt="Youth Empowerment"></div>
...
<div class="categories-section" id="categories">
  <div class="section">
    ...
    <div class="cat-grid">
      <div class="cat-card reveal"><div class="cat-img"><img src="https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=300&q=80" alt="Smartphones"><div class="cat-overlay"></div></div><div class="cat-info"><div class="cat-name">Smartphones</div><div class="cat-count">120+ Deals</div></div></div>
      <div class="cat-card reveal"><div class="cat-img"><img src="https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=300&q=80" alt="Laptops"><div class="cat-overlay"></div></div><div class="cat-info"><div class="cat-name">Laptops</div><div class="cat-count">85+ Deals</div></div></div>
      <div class="cat-card reveal"><div class="cat-img"><img src="https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=300&q=80" alt="Audio"><div class="cat-overlay"></div></div><div class="cat-info"><div class="cat-name">Audio</div><div class="cat-count">200+ Deals</div></div></div>
      <div class="cat-card reveal"><div class="cat-img"><img src="https://images.unsplash.com/photo-1612287230202-1ff1d85d1bdf?w=300&q=80" alt="Gaming"><div class="cat-overlay"></div></div><div class="cat-info"><div class="cat-name">Gaming</div><div class="cat-count">65+ Deals</div></div></div>
      <div class="cat-card reveal"><div class="cat-img"><img src="https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=300&q=80" alt="Kitchen"><div class="cat-overlay"></div></div><div class="cat-info"><div class="cat-name">Kitchen</div><div class="cat-count">150+ Deals</div></div></div>
      <div class="cat-card reveal"><div class="cat-img"><img src="https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=300&q=80" alt="Furniture"><div class="cat-overlay"></div></div><div class="cat-info"><div class="cat-name">Furniture</div><div class="cat-count">90+ Deals</div></div></div>
      <div class="cat-card reveal"><div class="cat-img"><img src="https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=300&q=80" alt="Fashion"><div class="cat-overlay"></div></div><div class="cat-info"><div class="cat-name">Fashion</div><div class="cat-count">500+ Deals</div></div></div>
      <div class="cat-card reveal"><div class="cat-img"><img src="https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=300&q=80" alt="Bags"><div class="cat-overlay"></div></div><div class="cat-info"><div class="cat-name">Bags</div><div class="cat-count">75+ Deals</div></div></div>
      <div class="cat-card reveal"><div class="cat-img"><img src="https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=300&q=80" alt="Auto Parts"><div class="cat-overlay"></div></div><div class="cat-info"><div class="cat-name">Auto Parts</div><div class="cat-count">110+ Deals</div></div></div>
      <div class="cat-card reveal"><div class="cat-img"><img src="https://images.unsplash.com/photo-1568772585407-9361f9bf3a87?w=300&q=80" alt="Bike Parts"><div class="cat-overlay"></div></div><div class="cat-info"><div class="cat-name">Bike Parts</div><div class="cat-count">80+ Deals</div></div></div>
      <div class="cat-card reveal"><div class="cat-img"><img src="https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=300&q=80" alt="Garden"><div class="cat-overlay"></div></div><div class="cat-info"><div class="cat-name">Garden</div><div class="cat-count">60+ Deals</div></div></div>
      <div class="cat-card reveal"><div class="cat-img"><img src="https://images.unsplash.com/photo-1563453392212-326f5e854473?w=300&q=80" alt="Cleaning"><div class="cat-overlay"></div></div><div class="cat-info"><div class="cat-name">Cleaning</div><div class="cat-count">45+ Deals</div></div></div>
    </div>
  </div>
</div>
...
<div style="padding:0 0 80px">
  <div class="promo-split reveal">
    <div class="promo-split-inner">
      <div class="promo-img"><img src="https://images.unsplash.com/photo-1607082349566-187342175e2f?w=800&q=80" alt="Special Offer"></div>
  ...
  <div class="enquiry-grid reveal">
    ...
    <div class="enquiry-form-box">
      ...
      <form action="{{ route('enquiry.store') }}" method="POST">
        @csrf
        <div class="ef-row full"><div class="ef-field"><label>Full Name <span style="color:var(--accent)">*</span></label><input type="text" name="name" placeholder="Enter your full name" value="{{ old('name') }}" required></div></div>
        <div class="ef-row full"><div class="ef-field"><label>Address <span style="color:var(--accent)">*</span></label><textarea name="address" placeholder="Enter your full address" rows="2" required>{{ old('address') }}</textarea></div></div>
        <div class="ef-row">
          <div class="ef-field"><label>Contact Number <span style="color:var(--accent)">*</span></label><input type="tel" name="phone" placeholder="+91 XXXXX XXXXX" value="{{ old('phone') }}" required></div>
          <div class="ef-field"><label>Email ID <span style="font-size:10px;color:var(--muted)">(Optional)</span></label><input type="email" name="email" placeholder="your@email.com" value="{{ old('email') }}"></div>
        </div>
        <div class="ef-row full"><div class="ef-field"><label>Occupation <span style="color:var(--accent)">*</span></label><input type="text" name="occupation" placeholder="e.g. Student, Business, Employee..." value="{{ old('occupation') }}" required></div></div>
        <div class="ef-row full">
          <div class="ef-field"><label>Interested in Affiliate Program <span style="color:var(--accent)">*</span></label>
        ...
        <div class="ef-row full"><div class="ef-field"><label>Any Experience about Affiliate <span style="font-size:10px;color:var(--muted)">(Optional)</span></label><textarea name="affiliate_experience" placeholder="Tell us about your affiliate marketing experience, if any...">{{ old('affiliate_experience') }}</textarea></div></div>
...
<footer id="footer">
  ...
  <div class="footer-bottom">
    <p>&copy; {{ date('Y') }} Yesb Confident E-Commerce & Advertising. All rights reserved.</p>
...
<script>
  ...
  window.addEventListener('scroll', () => {
    if (window.scrollY > 50) { navbar.classList.add('scrolled'); scrollTopBtn.classList.add('show'); }
    else { navbar.classList.remove('scrolled'); scrollTopBtn.classList.remove('show'); }
  });
